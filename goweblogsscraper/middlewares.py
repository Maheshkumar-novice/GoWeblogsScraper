...
class GoweblogsscraperSpiderMiddleware:
    ...
    @classmethod
    def from_crawler(cls, crawler: Spider) -> Spider:
        # This method is used by Scrapy to create your spiders.
        s = cls()
        crawler.signals.connect(s.spider_opened, signal=signals.spider_opened)
        return s

    def process_spider_input(self, response: Response, spider: Spider) -> None:  # noqa: ARG002
    ...
    def process_start_requests(self, start_requests: list, spider: Spider) -> Generator[Request, None, None]:  # noqa: ARG002
...
class GoweblogsscraperDownloaderMiddleware:
    ...
    def process_response(self, request: Request, response: Response, spider: Spider) -> Response:  # noqa: ARG002
